...
(defsystem "crazyflie_driver-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "HoverVel" :depends-on ("_package_HoverVel"))
    (:file "_package_HoverVel" :depends-on ("_package"))
    (:file "LogBlock" :depends-on ("_package_LogBlock"))
    (:file "_package_LogBlock" :depends-on ("_package"))
    (:file "NameArray" :depends-on ("_package_NameArray"))
    (:file "_package_NameArray" :depends-on ("_package"))
