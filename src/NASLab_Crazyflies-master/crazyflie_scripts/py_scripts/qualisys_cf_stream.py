...
async def main():
    ...
    for j in range(len(wanted_bodies)):
        ...
        msg = PointStamped()  # PointStamped: Header header; Point point (float64 x; float64 y; float64 z)
        # msg = PoseStamped()
        msg.header.seq = 0
...
if __name__ == "__main__":
    ...
    if charge_type == "Static":
        ...
        if replan:
            log_location = '/home/reed/Crazyfly_ws/src/NASLab_Crazyflies/crazyflie_scripts/' \
